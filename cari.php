...
<head>
	...
	<title>Pencarian Berita - Sport Zone</title>
	...
	<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-6" style="height:700px auto;">
						<div class="page-header">
							...
							<?php
							$kata = $_POST['cari'];
							$str = "SELECT * FROM berita WHERE judul like '%$kata%'";
						...
						<div class="media">
							...
							<div class="media-body">
								...
								<div class="media-body">
									<p><?php echo substr($row['isi'], 0, 300); ?> ...<br><br><a href="detail.php?id=<?php echo $row['id_berita']; ?>">Baca Selengkapnya >></a></p>
								</div>
							</div>
						<?php
							}
		...
		<div class="row">
			<div class="col-md-12" style="height:30px;background:black;color:white;">
				<footer>&copy; 2016 - Sport Zone - All Right Reserved. | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a></footer>
			</div>
		</div>
		<!--end footer-->
	</div>
