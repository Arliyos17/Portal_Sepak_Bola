								...
								<div role="tabpanel" class="tab-pane active" id="inggris">
									<div class="table-responsive">
										<table class="table table-striped">
											...
											<?php
												$query = mysqli_query($koneksi, "SELECT jadwal.tanggal, jadwal.waktu, tim1.nama_tim AS tim1_nama, hasil.skor_a, hasil.skor_b, tim2.nama_tim AS tim2_nama, jadwal.liga
													FROM jadwal
													INNER JOIN hasil ON jadwal.id_jadwal = hasil.id_jadwal
													INNER JOIN tim AS tim1 ON jadwal.id_tim1 = tim1.id_tim
													INNER JOIN tim AS tim2 ON jadwal.id_tim2 = tim2.id_tim
													WHERE liga='Inggris'
												...
												?>
													<tr style="text-align:center;">
														<td><?php echo $no; ?></td>
														<td><?php echo $row['tanggal']; ?><br><?php echo $row['waktu']; ?></td> 
														<td><?php echo $row['tim1_nama']; ?></td>
														<td><?php echo $row['skor_a']; ?>-<?php echo $row['skor_b']; ?></td>
														<td><?php echo $row['tim2_nama']; ?></td>
													</tr>
												<?php
													$no++;
												}
