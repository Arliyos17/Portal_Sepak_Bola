					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="../klasmen/">Klasemen</a></li>
									...
									<div class="table-responsive">
										<table class="table table-striped">
											<tr class="active">
												...
												<th style="text-align:center;">Kebobolan</th>
												<th style="text-align:center;">Selisih Goal</th>
												<th style="text-align:center;">Poin</th>
											</tr>
											<?php
											$query = mysqli_query($koneksi, "SELECT tim.nama_tim, klasmen.main, klasmen.menang, klasmen.seri, klasmen.kalah, klasmen.gol_kandang, klasmen.gol_tandang, klasmen.selisih_gol, klasmen.poin
											FROM tim 
											INNER JOIN klasmen
											ON tim.id_tim = klasmen.id_tim
											WHERE liga='Inggris'
											ORDER BY poin DESC");
											$no = 1;
											while ($row = mysqli_fetch_array($query)) {
